...
| | |
|---|---|
| generated | 2026-08-16 23:13:23 UTC |
| git commit | `f1d82cb` |
| git subject | rev 34: both probes REFUSE TO PRINT A RULING if a positive control failed -- arms 4 and 5 showed the ruling prose surviving a downed foundation, SPEC 10.87.2's family in probes written the same day |
| working tree | clean |
| blender | 4.5.3 LTS |
