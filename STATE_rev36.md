...
| | |
|---|---|
| generated | 2026-08-17 03:38:13 UTC |
| git commit | `7c74e57` |
| git subject | rev 36: the over-rider hoop ends meet the bumper -- the first geometry change since rev 30 |
| working tree | clean |
| blender | 4.5.3 LTS |
...
over-rider hoop ends (SPEC 10.90, rev 36): land on bumper_f with 0.02 / 0.02 mm residual (tol 1.0, TWO-SIDED); was 23.59 mm of clear air in rev 30-35. BAR_HALF_Y is now DERIVED (0.574387) from a FROZEN tip (0.629528); BAR_END_DROP and BAR_END_BACK are RETIRED.
...
|---|---|
| mesh objects | 186 |
| vertices (all meshes) | 144939 |
| faces (all meshes) | 139378 |
