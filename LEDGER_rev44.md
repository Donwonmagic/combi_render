...
| 21 | `ref_source.jpeg` is formally retired *and* load-bearing | **CLOSED, rev 44 — the premise was false.** §0.2 never retired it and carries no `ref_source` row; §10.22's *"retired in 0.2"* is a mis-citation, now struck. Five ⚠ locks are graded **M**, i.e. measured from that frame. What is real is a **resolution** ceiling: 246 × 197 px. |
