...
| `probe_rev45_ground.py` | 5 checked, **0 FAILED**. G4 **0.2519** (ablated 0.5475) | G4 < 0.45 | item D, partly closed |
...
* **WHAT IS LEFT:** the V and the W are each built as ONE mitred polyline, fused
  ...
  thing to try. **This is real work, and it is the owner's top-ranked item.**
